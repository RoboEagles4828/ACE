...
public class Vision {
    public volatile PixyThread.frame lastFrame;
    ...
    private void firstMove(){
        double b1Angle = lastFrame.frameData.get(0).angle;
        double b2Angle = lastFrame.frameData.get(1).angle;
    ...
    private void errorCorrection(){
        if(lastFrame.numBlocks() == 2){
            double b1Angle = lastFrame.frameData.get(0).angle;
            double b2Angle = lastFrame.frameData.get(1).angle;
            int b1x = lastFrame.frameData.get(0).getX();
            int b2x = lastFrame.frameData.get(1).getX();
