...
public class DriveTrainPID {
    ...
    // PID Values
    private static final double P_VAL = 0;
    private static final double I_VAL = 0;
    private static final double D_VAL = 0;
    private static final double FEED_FORWARD = 2.438;
     ...
     */
    DriveTrainPID(int frontLeftPort, int backLeftPort, int frontRightPort, int backRightPort) {
        ...
        frontLeft.setPID(P_VAL, I_VAL, D_VAL);
        frontRight.setPID(P_VAL, I_VAL, D_VAL);
        backLeft.setPID(P_VAL, I_VAL, D_VAL);
        backRight.setPID(P_VAL, I_VAL, D_VAL);
    ...
    void debugPID(){
        ...
        System.out.println("ERR: bl " + backLeft.getClosedLoopError() + " br " + backRight.getClosedLoopError() + " fl " + frontLeft.getClosedLoopError() + " fr " + frontRight.getClosedLoopError());
    }
